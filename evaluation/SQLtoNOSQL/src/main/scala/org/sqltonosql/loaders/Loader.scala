...
case class Loader(configFile: String) {
  ...
  def offer(inputPath: String, url: String, database: String, collection: String) {
    ...
    val spark = SparkSession.builder
      .master("local[*]")
      .appName("SQL dump to NoSQL Loader")
  ...
  def product(inputPath: String, keyspace: String, table: String) {
    ...
    /*
    spark.sql("CREATE DATABASE IF NOT EXISTS productCat.db WITH DBPROPERTIES (class='SimpleStrategy',replication_factor='1')")
    spark.sql("CREATE TABLE productCat.db.product (nr Int, comment string,  label string," +
      " producer Int, propertyNum1 Int, propertyNum2 Int, propertyNum3 Int, propertyNum4 Int, propertyNum5 Int," +
      " propertyNum6 string, propertyTex1 string, propertyTex2 string, propertyTex3 string," +
      " propertyTex4 string, propertyTex5 string, propertyTex6 string," +
      " publishDate date, publisher Int) USING cassandra PARTITIONED BY (nr)")
*/
    //List their contents
    //  spark.sql("SHOW NAMESPACES FROM productCat").show
    // spark.sql("SHOW TABLES FROM productCat.db").show
    ...
    linesA = linesA.map(l => if (l(5) == "null")
      Array(l(0), l(1), l(2), l(3), l(4), -1, l(6), l(7), l(8), l(9), l(10), l(11), l(12), l(13), l(14), l(15), l(16), l(17)) else l)

    linesA = linesA.map(l => if (l(6) == "null")
      Array(l(0), l(1), l(2), l(3), l(4), l(5), -1, l(7), l(8), l(9), l(10), l(11), l(12), l(13), l(14), l(15), l(16), l(17)) else l)
    linesA = linesA.map(l => if (l(7) == "null")
      Array(l(0), l(1), l(2), l(3), l(4), l(5), l(6), -1, l(8), -1, l(10), l(11), l(12), l(13), l(14), l(15), l(16), l(17)) else l)
    linesA = linesA.map(l => if (l(8) == "null")
      Array(l(0), l(1), l(2), l(3), l(4), l(5), l(6), l(7), -1, l(9), l(10), l(11), l(12), l(13), l(14), l(15), l(16), l(17)) else l)
    linesA = linesA.map(l => if (l(9) == "null")
      Array(l(0), l(1), l(2), l(3), l(4), l(5), l(6), l(7), l(8), -1, l(10), l(11), l(12), l(13), l(14), l(15), l(16), l(17)) else l)
    linesA = linesA.map(l => if (l(16) == "null")
      Array(l(0), l(1), l(2), l(3), l(4), l(5), l(6), l(7), l(8), l(8), l(10), l(11), l(12), l(13), l(14), l(15), -1, l(17)) else l)

    val rowRDD = linesA.map(l => Row(
      l(0).toString.toInt,
      l(1),
      l(2),
      l(3).toString.toInt,
      ...
      l(15).toString,
      l(16).toString.toInt,
      java.sql.Date.valueOf(l(17).toString.replace("'", "")))
    )
    ...
    val fields = Seq(
      StructField("nr", IntegerType, nullable = false),
      StructField("label", StringType, nullable = true),
      StructField("comment", StringType, nullable = true),
      StructField("producer", IntegerType, nullable = true),
      ...
      StructField("propertyNum5", IntegerType, nullable = true),
      StructField("propertyNum6", IntegerType, nullable = true),
      StructField("propertyTex1", StringType, nullable = true),
      StructField("propertyTex2", StringType, nullable = true),
      StructField("propertyTex3", StringType, nullable = true),
      StructField("propertyTex4", StringType, nullable = true),
      StructField("propertyTex5", StringType, nullable = true),
    ...
    productsDF.write.insertInto("productCat.db.product")

    productsDF.writeTo("productCat.db.product").append()
    productsDF.show()

    // var df  = spark.read.table("productCat.db.product")
