...
class DataQueryFrame {
  ...
  private val _selects: ListBuffer[(String, String, String)] = ListBuffer()
  private val _filters: ListBuffer[String] = ListBuffer()
  private val _joins: ListBuffer[(String, String, String, String)] = ListBuffer()
