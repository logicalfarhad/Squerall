...
import org.squerall.model.Triple;
import scala.Tuple2;
...
public class NTtoDF implements Serializable {
    ...
    public Dataset<Row> read(String input_path, String master) {

        SparkSession spark = SparkSession.builder().master(master).appName("Squerall").getOrCreate();
